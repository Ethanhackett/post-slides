...
function tc_post_slides_options() {
	...
	$stagePadding = get_option('stagePadding');
	...
	$autoplayTimeout = get_option('autoplayTimeout');
	if(empty($autoplayTimeout)){
		$autoplayTimeout = "5000";
	}
	$autoplayHoverPause = get_option('autoplayHoverPause');
	if(empty($autoplayHoverPause)){
		...
		<table border="0" id="general-settings">
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="stagePadding" value="<?= $stagePadding; ?>" class='small-input'><span class="px">px</span>
					</td>
				</tr>
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>
						<input type="text" name="autoplayTimeout" value="<?= $autoplayTimeout; ?>" class='small-input'>
					</td>
				</tr>
				<tr>
					<td>Autoplay Hover Pause:</td>
					<td>
						<input type="radio" name="autoplayHoverPause" value="true" <?php if($autoplayHoverPause == 'true') echo 'checked="checked"'; ?>>true
						<input type="radio" name="autoplayHoverPause" value="false" <?php if($autoplayHoverPause == 'false') echo 'checked="checked"'; ?>>false
					</td>
				</tr>
			</tvody>
		</table>
